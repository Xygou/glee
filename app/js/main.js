$(function(){
  ...
  $('.list-content__btn').on('click', function() {
    $('.list-content__btn').removeClass ('list-content__btn--active');
    $(this).addClass('list-content__btn--active');
  });
  
  $('.btn-list').on('click', function() {
    $('.product-card').addClass('product-card--list');
    $('.list-content__item').addClass('list-content__item--list');
  });

  $('.btn-grid').on('click', function () {
    $('.product-card').removeClass('product-card--list');
    $('.list-content__item').removeClass('list-content__item--list');
  });
